# About
安卓高斯模糊库，参考了[Blurry](https://github.com/wasabeef/Blurry)和[500px-android-blur](https://github.com/500px/500px-android-blur)，并做了扩展和优化
...
public class BlurActivity extends AppCompatActivity implements View.OnClickListener
{
    ...
    public void onClick(final View view)
    {
        ...
        // 自定义Target
        getBlurApi().blur(bitmap).async().into(new BlurApi.Target()
        {
            @Override
